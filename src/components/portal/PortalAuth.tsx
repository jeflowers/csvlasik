...
const PortalAuth: React.FC = () => {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    if (resetError) {
      ...
      setSuccessMsg('If an account exists with that email, you will receive a password reset link.');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-serif text-gray-900">Patient Portal</h1>
          <p className="text-sm text-gray-500 mt-1">ClearSight LASIK</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          {view === 'login' && (
            <>
              ...
              <p className="text-sm text-gray-500 mb-6">Sign in to access your patient portal.</p>
          ...
          {view === 'register' && (
            <>
              ...
              <p className="text-sm text-gray-500 mb-6">Register to securely manage your patient forms.</p>
