          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700 mt-1">
                {suspiciousPatterns.length} suspicious patterns detected in the last 24 hours
              </p>
          ...
          {activeTab === 'search' && (
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <button className="mt-4 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2">
